...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [_service_login_service__WEBPACK_IMPORTED_MODULE_7__["LoginService"]],
...
var LoginComponent = /** @class */ (function () {
    ...
    LoginComponent.prototype.loginUser = function (event) {
        ...
        this.login.getInfo(this.user).subscribe(function (data) {
...
var LoginService = /** @class */ (function () {
    function LoginService(http) {
        this.http = http;
        this.url = 'http://localhost:8080/HunterFleaMarket/login';
    }
    LoginService.prototype.getInfo = function (user) {
        return this.http.post(this.url, JSON.stringify(_model_user_model__WEBPACK_IMPORTED_MODULE_2__["User"]));
    };
...
module.exports = "<div class=\"row\">\n  <div class=\"col s8 offset-s2\">\n    <div class=\"\">\n      <div class=\"sm-jumbotron center-align\">\n        <h2>Hunter Registration</h2>\n      </div>\n      <form action=\"\" class=\"col s12\">\n        <div class=\"row\">\n              <div class=\"input-field col s6\">\n                <input id=\"hunter_name\" type=\"text\" class=\"validate\" #hunter_name=\"ngModel\" [(ngModel)]=\"user.hunter_name\" required>\n                <label for=\"hunter_name\">Hunter Name</label>\n              </div>\n              <div class=\"input-field col s6\">\n                <input id=\"rank\" type=\"text\" class=\"validate\" #rank=\"ngModel\" [(ngModel)]=\"user.rank\" required>\n                <label for=\"rank\">Rank</label>\n              </div>\n            </div>\n            <div class=\"row\">\n              <div class=\"input-field col s6\">\n                <input id=\"username\" type=\"text\" class=\"validate\" #username=\"ngModel\" [(ngModel)]=\"user.username\" required>\n                <label for=\"username\">Username</label>\n              </div>\n              <div class=\"input-field col s6\">\n                <input id=\"password\" type=\"password\" class=\"validate\" #password=\"ngModel\" [(ngModel)]=\"user.password\" required>\n                <label for=\"password\">Password</label>\n              </div>\n            </div>\n            <div class=\"row\">\n              <div class=\"input-field col s12\">\n                <input id=\"email\" type=\"email\" class=\"validate\" #email=\"ngModel\" [(ngModel)]=\"user.email\" required>\n                <label for=\"email\">Email</label>\n              </div>\n            </div>\n            <div class=\"row\">\n              <div class=\"center-align\">\n                <button class=\"btn-large btn-submit\" type=\"submit\">Submit</button>\n              </div>\n            </div>\n      </form>\n    </div>\n  </div>\n</div>\n"
...
module.exports = __webpack_require__(/*! C:\Users\Ted\Desktop\rev\MonsterHunterFleaMarket\project2\src\main.ts */"./src/main.ts");
